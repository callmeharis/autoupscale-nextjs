...
export default function DashboardTimeline() {
  ...
  return (
    <div className=' py-3'>
      ...
      <div className='p-3 max-w-7xl m-auto h-96 overflow-auto shadow-md '>
        {/*    
        <Timeline
          groups={groups}
          items={items}
              ...
              <form onSubmit={form.handleSubmit} onReset={form.handleReset}>
                <div className='flex items-end pb-0'>
                  <div className='mb-2 md:mb-0 md:mr-4 flex-grow '>
                    <p className='text-gray-400 tracking-wide text-sm mb-2 block'>Owner</p>
                    <Multiselect
...
DashboardTimeline.getLayout = function getLayout(page: ReactElement) {
